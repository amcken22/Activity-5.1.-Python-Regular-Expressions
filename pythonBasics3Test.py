...
#Test case for starts_with_non_number
    def test_starts_with_non_number(self):
        ...
        self.assertEqual(pythonBasics3.starts_with_non_number("^ stands for raising a number to an exponent"), True)

        self.assertEqual(pythonBasics3.starts_with_non_number("10 is greater than 8"), False)

        self.assertEqual(pythonBasics3.starts_with_non_number("% means modulus in Python"), True)
...
#Test case for multiple_words
    def test_multiple_words(self):
        ...
        # Please add three more test cases following the order above
        self.assertEqual(pythonBasics3.multiple_words("You're 10"), True)

        self.assertEqual(pythonBasics3.multiple_words(" Double-sided? "), False)

        self.assertEqual(pythonBasics3.multiple_words("This-is-very-fun"), False)
